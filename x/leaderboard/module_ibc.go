...
func (im IBCModule) OnRecvPacket(
	...
	case *types.LeaderboardPacketData_IbcTopRankPacket:
		packetAck, err := im.keeper.OnRecvIbcTopRankPacket(ctx, modulePacket, *packet.IbcTopRankPacket)
		if err != nil {
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.LeaderboardPacketData_IbcTopRankPacket:
		err := im.keeper.OnAcknowledgementIbcTopRankPacket(ctx, modulePacket, *packet.IbcTopRankPacket, ack)
		if err != nil {
			return err
		}
...
func (im IBCModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.LeaderboardPacketData_IbcTopRankPacket:
		err := im.keeper.OnTimeoutIbcTopRankPacket(ctx, modulePacket, *packet.IbcTopRankPacket)
		if err != nil {
			return err
		}
